...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spSetup_Index_sega]
	@UserID int = NULL,
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2199' SET @Description = 'Ad exec sp_RebuildDefragIndexes'
...
BEGIN TRY
    ...
    if 	@DataClassID is NULL and @DataClassTypeID is NULL
        begin
        SELECT top 1
