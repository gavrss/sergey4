...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spIU_DC_Journal_EpicorERP_20250410_orig]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
--	END
	...
	SET @Step = 'Insert opening balances into temp table #Journal'
		IF @DebugBM & 32 > 0 
			BEGIN		
				SELECT [TempTable_#FiscalPeriod] = '#FiscalPeriod', * FROM #FiscalPeriod ORDER BY FiscalPeriod
				SELECT DISTINCT FiscalPeriod FROM #Journal ORDER BY FiscalPeriod
			END
