...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spJIRA_IU_API_Calls_Epicor]
...
IF (@Operation = 'Update' AND @Exist_JiraIssueStatusID IN (10001, 17253, 6) and @BodyData not like N'%ErrorNumber = 51000%') -- (Done, Deployed, Closed). In the past: when DSPanel Jira:  ( Deployed, Closed: 10001, 6)
BEGIN
