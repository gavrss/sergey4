...
SET ANSI_NULLS ON
GO
Create PROCEDURE [dbo].[spIU_DC_Sales_Raw_20250708]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
BEGIN TRY
	...
	SET @Step = 'Fill temp table #Entity'
		...
		FROM
			...
			INNER JOIN pcINTEGRATOR_Data..Entity_Book EB ON EB.InstanceID = E.InstanceID AND EB.VersionID = E.VersionID AND EB.EntityID = E.EntityID AND EB.BookTypeBM & 8 > 0 AND EB.SelectYN <> 0
		WHERE	
			...
			BEGIN
				...
				SET @SQLStatement = '
					...
					FROM
						...
						--INNER JOIN #Plant Plant ON  Plant.Company = PC.Company AND Plant.PlantCostID = PC.CostID
				...
				SELECT
					...
					[OrderType] = CASE WHEN SUM(OD.DocUnitPrice) = 0 THEN 'FOC' ELSE
									...
									END,
					[Plant] = MAX(OD.Plant),
					[Product] = OD.PartNum, --[dbo].[f_ReplaceString] (@InstanceID, @VersionID,OD.PartNum, 1),
					...
					[SalesCOGSLabor] = SUM(-1 * OD.SellingQuantity * SIUM.ConvFactor / IUM.ConvFactor) * CASE MAX(PP.[CostMethod]) WHEN 'A' THEN SUM(ISNULL(PC.[AvgLaborCost], 0)) WHEN 'F' THEN SUM(ISNULL(PC.[FIFOAvgLaborCost], 0)) WHEN 'L' THEN SUM(ISNULL(PC.[LastLaborCost], 0)) WHEN 'S' THEN SUM(ISNULL(PC.[StdLaborCost], 0)) ELSE 0 END,
					[SalesCOGSMater] = SUM(-1 * OD.SellingQuantity * SIUM.ConvFactor / IUM.ConvFactor) * CASE MAX(PP.[CostMethod]) WHEN 'A' THEN SUM(ISNULL(PC.[AvgMaterialCost], 0)) WHEN 'F' THEN SUM(ISNULL(PC.[FIFOAvgMaterialCost], 0)) WHEN 'L' THEN SUM(ISNULL(PC.[LastMaterialCost], 0)) WHEN 'S' THEN SUM(ISNULL(PC.[StdMaterialCost], 0)) ELSE 0 END,
					[SalesCOGSBurden] = SUM(-1 * OD.SellingQuantity * SIUM.ConvFactor / IUM.ConvFactor) * CASE MAX(PP.[CostMethod]) WHEN 'A' THEN SUM(ISNULL(PC.[AvgBurdenCost], 0)) WHEN 'F' THEN SUM(ISNULL(PC.[FIFOAvgBurdenCost], 0)) WHEN 'L' THEN SUM(ISNULL(PC.[LastBurdenCost], 0)) WHEN 'S' THEN SUM(ISNULL(PC.[StdBurdenCost], 0)) ELSE 0 END,
					[SalesCOGSSubCont] = SUM(-1 * OD.SellingQuantity * SIUM.ConvFactor / IUM.ConvFactor) * CASE MAX(PP.[CostMethod]) WHEN 'A' THEN SUM(ISNULL(PC.[AvgSubContCost], 0)) WHEN 'F' THEN SUM(ISNULL(PC.[FIFOAvgSubContCost], 0)) WHEN 'L' THEN SUM(ISNULL(PC.[LastSubContCost], 0)) WHEN 'S' THEN SUM(ISNULL(PC.[StdSubContCost], 0)) ELSE 0 END,
					[SalesCOGSMatBurd] = SUM(-1 * OD.SellingQuantity * SIUM.ConvFactor / IUM.ConvFactor) * CASE MAX(PP.[CostMethod]) WHEN 'A' THEN SUM(ISNULL(PC.[AvgMtlBurCost], 0)) WHEN 'F' THEN SUM(ISNULL(PC.[FIFOAvgMtlBurCost], 0)) WHEN 'L' THEN SUM(ISNULL(PC.[LastMtlBurCost], 0)) WHEN 'S' THEN SUM(ISNULL(PC.[StdMtlBurCost], 0)) ELSE 0 END,

					[SalesCOGSLabor_Unit] = -1 * MAX(SIUM.ConvFactor / IUM.ConvFactor) * CASE MAX(PP.[CostMethod]) WHEN 'A' THEN MAX(ISNULL(PC.[AvgLaborCost], 0)) WHEN 'F' THEN MAX(ISNULL(PC.[FIFOAvgLaborCost], 0)) WHEN 'L' THEN MAX(ISNULL(PC.[LastLaborCost], 0)) WHEN 'S' THEN MAX(ISNULL(PC.[StdLaborCost], 0)) ELSE 0 END,
					[SalesCOGSMater_Unit] = -1 * MAX(SIUM.ConvFactor / IUM.ConvFactor) * CASE MAX(PP.[CostMethod]) WHEN 'A' THEN MAX(ISNULL(PC.[AvgMaterialCost], 0)) WHEN 'F' THEN MAX(ISNULL(PC.[FIFOAvgMaterialCost], 0)) WHEN 'L' THEN MAX(ISNULL(PC.[LastMaterialCost], 0)) WHEN 'S' THEN MAX(ISNULL(PC.[StdMaterialCost], 0)) ELSE 0 END,
					[SalesCOGSBurden_Unit] = -1 * MAX(SIUM.ConvFactor / IUM.ConvFactor) * CASE MAX(PP.[CostMethod]) WHEN 'A' THEN MAX(ISNULL(PC.[AvgBurdenCost], 0)) WHEN 'F' THEN MAX(ISNULL(PC.[FIFOAvgBurdenCost], 0)) WHEN 'L' THEN MAX(ISNULL(PC.[LastBurdenCost], 0)) WHEN 'S' THEN MAX(ISNULL(PC.[StdBurdenCost], 0)) ELSE 0 END,
					[SalesCOGSSubCont_Unit] = -1 * MAX(SIUM.ConvFactor / IUM.ConvFactor) * CASE MAX(PP.[CostMethod]) WHEN 'A' THEN MAX(ISNULL(PC.[AvgSubContCost], 0)) WHEN 'F' THEN MAX(ISNULL(PC.[FIFOAvgSubContCost], 0)) WHEN 'L' THEN MAX(ISNULL(PC.[LastSubContCost], 0)) WHEN 'S' THEN MAX(ISNULL(PC.[StdSubContCost], 0)) ELSE 0 END,
					[SalesCOGSMatBurd_Unit] = -1 * MAX(SIUM.ConvFactor / IUM.ConvFactor) * CASE MAX(PP.[CostMethod]) WHEN 'A' THEN MAX(ISNULL(PC.[AvgMtlBurCost], 0)) WHEN 'F' THEN MAX(ISNULL(PC.[FIFOAvgMtlBurCost], 0)) WHEN 'L' THEN MAX(ISNULL(PC.[LastMtlBurCost], 0)) WHEN 'S' THEN MAX(ISNULL(PC.[StdMtlBurCost], 0)) ELSE 0 END,

					[SalesQtyUnit_] = SUM(OD.SellingQuantity * SIUM.ConvFactor),
				...
				GROUP BY 
					...
					OD.Company + '_' + (CASE LEN(OD.[OrderNum]) WHEN 1 THEN '000000' WHEN 2 THEN '00000'  WHEN 3 THEN '0000'  WHEN 4 THEN '000'  WHEN 5 THEN '00' WHEN 6 THEN '0' ELSE '' END + CONVERT(nvarchar(255), OD.OrderNum)) COLLATE DATABASE_DEFAULT,
					OS.[Label],
					OD.PartNum
			...
			BEGIN  
				...
				SET @SQLStatement = '
					...
					SELECT 
						...
						--[InvoiceLine] = MAX(ID.[InvoiceLine]),
					...
					FROM
						' + @SourceDatabase + '.[' + @Owner + '].[InvcHead] IH
						INNER JOIN ' + @SourceDatabase + '.[' + @Owner + '].[InvcDtl] ID ON ID.Company = IH.Company AND ID.InvoiceNum = IH.InvoiceNum
						INNER JOIN ' + @SourceDatabase + '.[' + @Owner + '].[OrderRel] [OR] ON [OR].[Company] = [ID].[Company] AND [OR].[OrderNum] = [ID].[OrderNum] AND [OR].[OrderLine] = [ID].[OrderLine]
					WHERE
						IH.Company IN (' + @EntityString + ') AND
						(IH.InvoiceDate >= ''' + CONVERT(nvarchar(15), @StartYear) + '-01-01'' OR IH.DueDate >= ''' + CONVERT(nvarchar(15), @StartYear) + '-01-01'' OR IH.ClosedDate >= ''' + CONVERT(nvarchar(15), @StartYear) + '-01-01'')
						' + CASE WHEN @StartDate IS NOT NULL THEN 'AND (IH.InvoiceDate >= ''' + CONVERT(nvarchar(10), @StartDate) + ''' OR IH.DueDate >= ''' + CONVERT(nvarchar(10), @StartDate) + ''' OR IH.ClosedDate >= ''' + CONVERT(nvarchar(10), @StartDate) + ''')' ELSE '' END + '
				...
				SELECT
					[Currency] = MAX(ID.CurrencyCode),			
					[Customer] = C.CustID + CASE WHEN LEN(ISNULL(ID.ShipToNum, '')) = 0 THEN '' ELSE '_' + ID.ShipToNum END,
					[Entity] = ID.Company,
					[InvoiceNo_AR] = ID.Company + '_' + (CASE LEN(ID.[InvoiceNum]) WHEN 1 THEN '00000' WHEN 2 THEN '0000' WHEN 3 THEN '000' WHEN 4 THEN '00' WHEN 5 THEN '0' ELSE '' END + CONVERT(nvarchar(255), ID.InvoiceNum)) COLLATE DATABASE_DEFAULT,
					[OrderLine] = CONVERT(nvarchar(255), ID.OrderLine),
					[OrderNo] = ID.Company + '_' + (CASE LEN(ID.[OrderNum]) WHEN 1 THEN '000000' WHEN 2 THEN '00000'  WHEN 3 THEN '0000'  WHEN 4 THEN '000'  WHEN 5 THEN '00' WHEN 6 THEN '0' ELSE '' END + CONVERT(nvarchar(255), ID.OrderNum)) COLLATE DATABASE_DEFAULT,
					[OrderState] = OS.[Label],
					[OrderType] = CASE WHEN SUM(ID.DocExtPrice) = 0 THEN 'FOC' ELSE
									...
									END,
					[Plant] = MAX(ID.Plant),
					[Product] = ID.PartNum, --[dbo].[f_ReplaceText] (ID.PartNum, 1),
					...
					[SalesCOGSLabor] = -1 * CASE WHEN MAX(CONVERT(int, ID.CreditMemo)) <> 0 THEN SUM(IDC.LbrUnitCost * IDC.SellingShipQty * SIUM.ConvFactor / IUM.ConvFactor) ELSE SUM(ID.LbrUnitCost * ID.SellingShipQty * SIUM.ConvFactor / IUM.ConvFactor) END,
					[SalesCOGSMater] = -1 * CASE WHEN MAX(CONVERT(int, ID.CreditMemo)) <> 0 THEN SUM(IDC.MtlUnitCost * IDC.SellingShipQty * SIUM.ConvFactor / IUM.ConvFactor) ELSE SUM(ID.MtlUnitCost * ID.SellingShipQty * SIUM.ConvFactor / IUM.ConvFactor) END,
					[SalesCOGSBurden] = -1 * CASE WHEN MAX(CONVERT(int, ID.CreditMemo)) <> 0 THEN SUM(IDC.BurUnitCost * IDC.SellingShipQty * SIUM.ConvFactor / IUM.ConvFactor) ELSE SUM(ID.BurUnitCost * ID.SellingShipQty * SIUM.ConvFactor / IUM.ConvFactor) END,
					[SalesCOGSSubCont] = -1 * CASE WHEN MAX(CONVERT(int, ID.CreditMemo)) <> 0 THEN SUM(IDC.SubUnitCost * IDC.SellingShipQty * SIUM.ConvFactor / IUM.ConvFactor) ELSE SUM(ID.SubUnitCost * ID.SellingShipQty * SIUM.ConvFactor / IUM.ConvFactor) END,
					[SalesCOGSMatBurd] = -1 * CASE WHEN MAX(CONVERT(int, ID.CreditMemo)) <> 0 THEN SUM(IDC.MtlBurUnitCost * IDC.SellingShipQty * SIUM.ConvFactor / IUM.ConvFactor) ELSE SUM(ID.MtlBurUnitCost * ID.SellingShipQty * SIUM.ConvFactor / IUM.ConvFactor) END,

					[SalesCOGSLabor_Unit] = -1 * CASE WHEN MAX(CONVERT(int, ID.CreditMemo)) <> 0 THEN MAX(IDC.LbrUnitCost) ELSE MAX(ID.LbrUnitCost) END * MAX(SIUM.ConvFactor / IUM.ConvFactor),
					[SalesCOGSMater_Unit] = -1 * CASE WHEN MAX(CONVERT(int, ID.CreditMemo)) <> 0 THEN MAX(IDC.MtlUnitCost) ELSE MAX(ID.MtlUnitCost) END * MAX(SIUM.ConvFactor / IUM.ConvFactor),
					[SalesCOGSBurden_Unit] = -1 * CASE WHEN MAX(CONVERT(int, ID.CreditMemo)) <> 0 THEN MAX(IDC.BurUnitCost) ELSE MAX(ID.BurUnitCost) END * MAX(SIUM.ConvFactor / IUM.ConvFactor),
					[SalesCOGSSubCont_Unit] = -1 * CASE WHEN MAX(CONVERT(int, ID.CreditMemo)) <> 0 THEN MAX(IDC.SubUnitCost) ELSE MAX(ID.SubUnitCost) END * MAX(SIUM.ConvFactor / IUM.ConvFactor),
					[SalesCOGSMatBurd_Unit] = -1 * CASE WHEN MAX(CONVERT(int, ID.CreditMemo)) <> 0 THEN MAX(IDC.MtlBurUnitCost) ELSE MAX(ID.MtlBurUnitCost) END * MAX(SIUM.ConvFactor / IUM.ConvFactor),

					[SalesQtyUnit_] = SUM(ID.SellingShipQty * SIUM.ConvFactor),
				...
				FROM
					...
					LEFT JOIN #ID IDC ON ID.CreditMemo = 1 AND IDC.Company = ID.Company AND IDC.InvoiceNum = ID.InvoiceRef AND IDC.OrderLine = ID.OrderLine AND IDC.PartNum = ID.PartNum AND IDC.InvoiceLine = ID.InvoiceLine
				...
				GROUP BY
					...
					ID.Company,
					ID.Company + '_' + (CASE LEN(ID.[InvoiceNum]) WHEN 1 THEN '00000' WHEN 2 THEN '0000' WHEN 3 THEN '000' WHEN 4 THEN '00' WHEN 5 THEN '0' ELSE '' END + CONVERT(nvarchar(255), ID.InvoiceNum)) COLLATE DATABASE_DEFAULT,
					CONVERT(nvarchar(255), ID.OrderLine),
					ID.Company + '_' + (CASE LEN(ID.[OrderNum]) WHEN 1 THEN '000000' WHEN 2 THEN '00000'  WHEN 3 THEN '0000'  WHEN 4 THEN '000'  WHEN 5 THEN '00' WHEN 6 THEN '0' ELSE '' END + CONVERT(nvarchar(255), ID.OrderNum)) COLLATE DATABASE_DEFAULT,
					OS.[Label],
					ID.PartNum
	...
	SET @Step = 'Update Currency'
		...
		UPDATE SR
		SET [Currency] = ISNULL(C.Currency, E.Currency)
		FROM 
			#DC_Sales_Raw SR
			INNER JOIN #Entity_Currency E ON E.Entity = SR.Entity 
			LEFT JOIN #Callisto_Currency C ON C.Currency = SR.Currency
		WHERE SR.Currency <> 'NONE'

		SET @Updated = @Updated + @@ROWCOUNT

	SET @Step = 'Return rows'
		IF @CalledYN = 0
			SELECT TempTable = '#DC_Sales_Raw', * FROM #DC_Sales_Raw ORDER BY [TimeDay], [Currency], [Entity]
