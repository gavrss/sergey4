...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalGet_DataClass_Data_20231004_nehatest]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
AS
/*
EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data_20231004_nehatest] @ActingAs='10769',@DataClassID='5971',
@Filter='TimeView=Periodic|Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=All_|Entity=All_|Scenario=All_|Time=202309|Version=NONE|LineItem=All_|GL_Department=All_|GL_Division=All_',
@InstanceID='648',@ResultTypeBM='256',@RowList='Account=10030,10036,10037,11000,12100,12115,10000,10025,20000,21000,23000',
@Tuple='',@UseCacheYN='true',@UserID='28023',@VersionID='1118',@DebugBM=63
