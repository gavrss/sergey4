...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spCheckSum_Member_Missing_Hierarchy_20240324]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2199' SET @Description = 'Checking if Hierarchy_Cursor exist - then CLOSE DEALLOCATE it'
