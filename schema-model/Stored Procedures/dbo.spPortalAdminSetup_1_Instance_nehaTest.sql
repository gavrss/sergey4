...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalAdminSetup_1_Instance_nehaTest]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
--5. Create another Version (Existing CustomerID/InstanceID/VersionID)
EXEC [spPortalAdminSetup_1_Instance_nehaTest]
	@UserID = -10,
	@InstanceID = 0,
	@VersionID = 0,
	@SourceTypeID = 11,
	@StorageTypeBM = 4,
	@DemoYN = 1,
	@AssignedCustomerID = 437,
	@AssignedInstanceID = 531,
	@AssignedVersionID = NULL,
	@CustomerName = 'PCX Aerostructures',
	@InstanceName = 'PCX Aerostructures',
	@ApplicationName = 'PCX',
	@ProductKey = NULL, 
	@Email = 'neha@test.com',
	@UserNameAD = NULL,
	...
	@StartYear = 2019, 
	@EndYear = 2024,
	@FiscalYearStarMonth = 1,
	@FiscalYearNaming = 0,
	@SourceServer = 'DSPSOURCE01',
	@SourceDatabase = 'pcSource_PCX',
	@BrandID = 2,
	@ModelingComment = 'VersionID Setup',
	@DebugBM = 6
