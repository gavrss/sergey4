...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalAdminGet_SqlQueryGroup]
(
	@UserID int = NULL,
	@InstanceID int = NULL,
	@JobID int = 0,
...
/*
	EXEC dbo.[spPortalAdminGet_SqlQueryGroup] @UserID = 1005, @InstanceID = 0, @Debug = 1
	EXEC dbo.[spPortalAdminGet_SqlQueryGroup] @UserID = 1005, @Debug = 1
	EXEC dbo.[spPortalAdminGet_SqlQueryGroup] @GetVersion = 1
*/	
