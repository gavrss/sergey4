...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalConvert_DataClass_Filter_New3]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
*/
	...
	SET @Step = 'Return data'
		...
		IF @ResultTemplate = 'Journal'
			EXEC [dbo].[spPortalGet_Journal_New3] @UserID = @UserID, @InstanceID = @InstanceID, @VersionID = @VersionID, @ResultTypeBM = @ResultTypeBM, @FieldTypeBM = @FieldTypeBM, @SQL_MultiDimJoin = @SQL_MultiDimJoin, @Rows = @Rows, @Debug = @DebugSub
