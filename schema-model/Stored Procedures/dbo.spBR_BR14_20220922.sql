...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spBR_BR14_20220922]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
DECLARE
	...
	@Version nvarchar(50) = '2.1.2.2186'
		...
		DECLARE BR14_Cursor CURSOR FOR
			...
			WHILE @@FETCH_STATUS = 0
				BEGIN
					...
					IF @DebugBM & 2 > 0 SELECT [@ID] = @ID, [@StepReference] = @StepReference, [@ICCounterpart] = @ICCounterpart, [@Method] = @Method, [@DimensionFilter]=@DimensionFilter
