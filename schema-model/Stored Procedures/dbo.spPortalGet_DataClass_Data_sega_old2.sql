...
SET ANSI_NULLS ON
GO
create PROCEDURE [dbo].[spPortalGet_DataClass_Data_sega_old2]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
EXEC [spPortalGet_DataClass_Data_sega] @GetVersion = 1
*/
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2199' SET @Description = 'Added @DataClassID on checking missing Measure. Checking existing Dimensions in DataClass after the filling temp tables #GroupBy, #WhereTotal'
