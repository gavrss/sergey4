...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalConvert_DataClass_Filter_20220829]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
AS
/*
 -- get data with {"TKey":"Account:6","TValue":"PERMFUND"}
EXEC spRun_Procedure_KeyValuePair @ProcedureName='spPortalConvert_DataClass_Filter',@JSON='[{"TKey":"DebugBM","TValue":"0"},
{"TKey":"UserID","TValue":"9648"},{"TKey":"InstanceID","TValue":"556"},{"TKey":"VersionID","TValue":"1067"},{"TKey":"DataClassID","TValue":"5648"},{"TKey":"ResultTypeBM","TValue":"36"},{"TKey":"Rows","TValue":"500"}
]',@JSON_table='[
{"TKey":"Entity","TValue":"159897"},{"TKey":"Account:6","TValue":"PERMFUND"},{"TKey":"Description","TValue":"Regis Aged Care Pty Ltd"},{"TKey":"GL_Cost_Centre","TValue":"ACF"},{"TKey":"LineItem","TValue":"NONE"},
{"TKey":"GL_Reference","TValue":"All_"},{"TKey":"Time","TValue":"202207"},{"TKey":"GL_Business_Unit","TValue":"All_"},{"TKey":"BusinessRule","TValue":"All_"},{"TKey":"Flow","TValue":"All_"},{"TKey":"Scenario","TValue":"ACTUAL"},
{"TKey":"Version","TValue":"NONE"},{"TKey":"Currency","TValue":"AUD"},{"TKey":"Measure","TValue":"Financials"},{"TKey":"TimeView","TValue":"Periodic"},{"TKey":"GL_Entity","TValue":"All_"},{"TKey":"BusinessProcess","TValue":"CONSOLIDATED"}]'

EXEC spRun_Procedure_KeyValuePair @ProcedureName='spPortalConvert_DataClass_Filter',@JSON='[
{"TKey":"UserID","TValue":"9648"},{"TKey":"InstanceID","TValue":"556"},{"TKey":"VersionID","TValue":"1067"},{"TKey":"DataClassID","TValue":"5648"},{"TKey":"ResultTypeBM","TValue":"3"}
]',@JSON_table='[
{"TKey":"Entity","TValue":"159897"},{"TKey":"Account:6","TValue":"PERMFUND"},{"TKey":"Description","TValue":"Regis Aged Care Pty Ltd"},{"TKey":"GL_Cost_Centre","TValue":"ACF"},{"TKey":"LineItem","TValue":"NONE"},
{"TKey":"GL_Reference","TValue":"All_"},{"TKey":"Time","TValue":"202207"},{"TKey":"GL_Business_Unit","TValue":"All_"},{"TKey":"BusinessRule","TValue":"All_"},{"TKey":"Flow","TValue":"All_"},{"TKey":"Scenario","TValue":"ACTUAL"},
{"TKey":"Version","TValue":"NONE"},{"TKey":"Currency","TValue":"AUD"},{"TKey":"Measure","TValue":"Financials"},{"TKey":"TimeView","TValue":"Periodic"},{"TKey":"GL_Entity","TValue":"All_"},{"TKey":"BusinessProcess","TValue":"CONSOLIDATED"}]'
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2187' SET @Description = 'In Dimension_Cursor, update [LeafLeverFilter] FROM #DimensionFilter ONLY if NULL or empty (sample case: handling alternate hierarchy).'
...
--					@Hierarchy nvarchar(1024) = NULL, --Only for backwards compatibility (not valid for tuples)
	...
	SET @Step = 'Fill table #DimensionFilter'
		...
		WHERE
			...
			FT.[DimensionID] NOT IN (-2, -8, -26, -27, -77) AND
	...
	SET @Step = 'Update [Filter] column in #DimensionFilter with correct @Entity'
		...
		IF @DebugBM & 2 > 0 SELECT TempTable = '#DimensionFilter_before_Dimension Cursor', * FROM #DimensionFilter
	...
	SET @Step = 'Return data'
		IF @DebugBM & 1 > 0 
			BEGIN
				SELECT [@ResultTemplate] = @ResultTemplate, [@UserID] = @UserID, [@InstanceID] = @InstanceID, [@VersionID] = @VersionID, [@ResultTypeBM] = @ResultTypeBM, [@FieldTypeBM] = 1, [@Rows] = @Rows, [@Debug] = @DebugSub
				SELECT [TempTable] = '#DimensionFilter', * FROM #DimensionFilter
			END
		
		IF @ResultTemplate = 'Journal'
			EXEC [dbo].[spPortalGet_Journal] @UserID = @UserID, @InstanceID = @InstanceID, @VersionID = @VersionID, @ResultTypeBM = @ResultTypeBM, @FieldTypeBM = 1, @SQL_MultiDimJoin = @SQL_MultiDimJoin, @Rows = @Rows, @Debug = @DebugSub
