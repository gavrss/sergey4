...
SET ANSI_NULLS ON
GO
create PROCEDURE [dbo].[spPortalGet_DataClass_Data_20230912_nehatest]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
AS
/*
EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @ActingAs='5892',@AssignmentID='22067',@DataClassID='5795',@DebugBM=3,
@Filter='Flow=NONE|Time=2024|Scenario=BUDGET|Entity=MAC|Currency=MXN|FullAccount=UAI|BusinessProcess=INPUT|BusinessRule=NONE|Version=NONE',
@GroupBy='Time|FullAccount',@InstanceID='596',@Measure='Financials',@ResultTypeBM='8',@RowList='SupressZeroYN=0',@UseCacheYN='true',@UserID='10828',@VersionID='1091'
