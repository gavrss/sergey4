...
CREATE PROCEDURE [dbo].[spPortalGet_Journal_20230712_before_fix_duplicatesAccountPCX2_SM] 
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2197' SET @Description = '1. Handle InterCompanyEntity. 2. Filter out parents for dimension<>FiscalYear. Its related to [MappingTypeID] = 1 and 2.'
...
------------------------------------------------------------------
							...
							--ELSE IF @DataColumn IN ('FiscalYear')
							--	SELECT DISTINCT
							--		ResultTypeBM = 2, 
							--		Dim =  @ParameterName,
							--		MemberID,
