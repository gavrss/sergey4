...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spBR_BR05_New3]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
EXEC [spBR_BR05_New3] @UserID=-10, @InstanceID=576, @VersionID=1082, @BusinessRuleID = 2717, @FiscalYear = 2019, @ConsolidationGroup = 'G_AXYZ', @DebugBM=16 --, @Entity_MemberKey = '101'
EXEC [spBR_BR05_New3] @UserID=-10, @InstanceID=576, @VersionID=1082, @BusinessRuleID = 2717, @FiscalYear = 2020, @ConsolidationGroup = 'G_AXYZ', @DebugBM=16 --, @Entity_MemberKey = '101'
EXEC [spBR_BR05_New3] @UserID=-10, @InstanceID=576, @VersionID=1082, @BusinessRuleID = 2717, @FiscalYear = 2021, @ConsolidationGroup = 'G_AXYZ', @DebugBM=16
EXEC [spBR_BR05_New3] @UserID=-10, @InstanceID=576, @VersionID=1082, @BusinessRuleID = 2717, @FiscalYear = 2022, @ConsolidationGroup = 'G_AXYZ', @DebugBM=16
...
SELECT
	...
	[@DebugSub] = @DebugSub
														...
														EXEC [pcINTEGRATOR]..spRun_Procedure_KeyValuePair @ProcedureName = 'spBR_BR05_CopyOpen_New3', @JSON = @JSON

													--	EXEC [spBR_BR05_CopyOpen_New3]
													--		@UserID=@UserID,
													--		@InstanceID=@InstanceID,
													--		@VersionID=@VersionID,
													--		@BusinessRuleID=@BusinessRuleID,
												...
												IF (SELECT COUNT(1) FROM #EntityBook WHERE [SourceDataClassID] = @Financials_DataClassID AND [SelectYN] <> 0) > 0
													BEGIN
														...
														EXEC [pcINTEGRATOR]..spRun_Procedure_KeyValuePair @ProcedureName = 'spBR_BR05_CopyOpen_Financials_New3', @JSON = @JSON

														--EXEC [spBR_BR05_CopyOpen_Financials_New3] 
														--	@UserID=@UserID, 	
														--	@InstanceID = @InstanceID,
														--	@VersionID = @VersionID,
														--	@BusinessRuleID = @BusinessRuleID,
