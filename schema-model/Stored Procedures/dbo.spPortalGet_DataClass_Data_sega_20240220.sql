...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalGet_DataClass_Data_sega_20240220]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2199' SET @Description = 'DB-1631: Fix minor issue on @Tuple with only TimeView filter. DB-1638: In ResultypeBM = 8 (Changeable), return correct changeability value for WFS writeAccess state. FEA-8636: Refer to DC.[Time_MemberId] for @TImeType=TimeDay when setting @SQL_Tuple.'
