...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spSet_Hierarchy_20250307_nehatest]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
AS
/*
--TRUNCATE TABLE [pcDATA_AIMA].[dbo].[S_HS_ProjectManual_RENTON01]
--TRUNCATE TABLE [pcDATA_AIMA].[dbo].[O_HS_ProjectManual_RENTON01]
...
EXEC [pcINTEGRATOR].[dbo].[spSet_Hierarchy]
	...
	@Debug = @DebugSub,
	@HierarchyNo = 1,
	@HierarchyName = 'RENTON01',
	@ParentColumn = 'Parent_RENTON01'
