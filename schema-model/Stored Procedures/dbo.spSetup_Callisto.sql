...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spSetup_Callisto]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
AS
/*
EXEC [spSetup_Callisto] @UserID=-10, @InstanceID=52, @VersionID=1035, @SequenceBM = 1, @DebugBM = 2
EXEC [spSetup_Callisto] @UserID=-10, @InstanceID=-1493, @VersionID=-1493, @SequenceBM = 23, @DebugBM = 3
EXEC [spSetup_Callisto] @UserID=-10, @InstanceID=529, @VersionID=1001, @SequenceBM = 19, @DebugBM = 3
EXEC [spSetup_Callisto] @UserID=-10, @InstanceID=531, @VersionID=1041, @SequenceBM = 19, @DebugBM = 3
EXEC [spSetup_Callisto] @UserID = -10, @InstanceID = -1714, @VersionID = -1714
EXEC [spSetup_Callisto] @UserID = -10, @InstanceID = -1718, @VersionID = -1718

EXEC [spSetup_Callisto] @GetVersion = 1
*/
