...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalGet_DataClass_Data_20230904_nehatest]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data_20230904_nehatest] @ActingAs='5892',@AssignmentID='22067',@DataClassID='5795',@DebugBM='15',
@Filter='Flow=NONE|Time=2024|Scenario=BUDGET|Entity=MAC|Currency=MXN|FullAccount=6101-04002-004|BusinessProcess=INPUT|BusinessRule=NONE|Version=NONE',
@GroupBy='Time|FullAccount',@InstanceID='596',@Measure='Financials',@ResultTypeBM='8',
@RowList='SupressZeroYN=0',@UseCacheYN='true',@UserID='10834',@VersionID='1091'
