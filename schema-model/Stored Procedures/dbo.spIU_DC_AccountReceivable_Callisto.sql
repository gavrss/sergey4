...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spIU_DC_AccountReceivable_Callisto]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
AS
/*
EXEC [spIU_DC_AccountReceivable_Callisto] @UserID=-10, @InstanceID=817, @VersionID=1236, @DebugBM=31
...
BEGIN TRY
	...
	SET @Step = 'Insert into temp table'
		EXEC [pcINTEGRATOR].[dbo].[spIU_DC_AccountReceivable_Raw] @UserID=@UserID, @InstanceID=@InstanceID, @VersionID=@VersionID, @DataClassID=@DataClassID, @JobID=@JobID, @Debug = @DebugSub
