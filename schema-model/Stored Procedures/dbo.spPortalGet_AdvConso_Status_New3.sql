...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalGet_AdvConso_Status_New3]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
EXEC [spPortalGet_AdvConso_Status_New3] @UserID=-10, @InstanceID=576, @VersionID=1082, @Group_MemberKey = 'G_AXYZ', @Debug=1
