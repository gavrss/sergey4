...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spIU_Dim_Scenario_Callisto]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
		...
		SET @SQLStatement = '
			...
			WHERE 
				...
				(
					...
					[' + @DimensionName + '].[WorkflowState] <> Members.[WorkflowState] OR  
					[' + @DimensionName + '].[WorkflowState_MemberID] <> Members.[WorkflowState_MemberID] OR  
