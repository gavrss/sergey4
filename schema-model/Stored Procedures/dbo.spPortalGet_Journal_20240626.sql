...
CREATE PROCEDURE [dbo].[spPortalGet_Journal_20240626] 
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2199' SET @Description = 'Handle [Group] for ResultTypeBM IN (1, 2), Changed default value for @TransactionTypeBM from 19 to 27.'
