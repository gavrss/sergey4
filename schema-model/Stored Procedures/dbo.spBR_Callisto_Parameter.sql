...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spBR_Callisto_Parameter]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.1.2199' SET @Description = 'Set TimeOut = 60 minutes instead of 30. Added @ActionType=''End'' for spSet_Job at the end of the SP.'
...
SET @Step = 'Capture ParameterValues'
	IF @JobID IS NULL
		BEGIN
			SET @TimeOut = ISNULL(@TimeOut, '03:00:00') -- ISNULL(@TimeOut, '00:30:00')
