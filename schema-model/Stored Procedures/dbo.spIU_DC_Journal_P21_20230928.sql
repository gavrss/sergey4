...
CREATE PROCEDURE [dbo].[spIU_DC_Journal_P21_20230928]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
AS
/*
EXEC [spIU_DC_Journal_P21] @UserID = -10, @InstanceID = 515, @VersionID = 1064, @SequenceBM = 1, @Entity_MemberKey = 'REM', @Book = GL, @FiscalYear = 2023, @FiscalPeriod = 2, @DebugBM = 2
