...
SET ANSI_NULLS ON
GO
create PROCEDURE [dbo].[spPortalAdminSet_WorkflowState_Reset_sega]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
DECLARE
	...
	@Version nvarchar(50) = '2.1.0.2199'
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.0.2199' SET @Description = 'Handle info message'
...
-- 				SET @Severity = 16
-- 				GOTO EXITPOINT
				SET @InfoMessage = 'The Scenario for selected Workflow does not allow input.';
