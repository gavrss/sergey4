...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spBR_BR05_Consolidation_20230221]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
AS
/*
EXEC [spBR_BR05_Consolidation] @UserID=-10, @InstanceID=529, @VersionID=1001, @BusinessRuleID = 1001, @DebugBM=3
