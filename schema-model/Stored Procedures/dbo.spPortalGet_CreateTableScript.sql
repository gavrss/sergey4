...
CREATE PROCEDURE [dbo].[spPortalGet_CreateTableScript]
	@UserID INT = -10,
	@InstanceID INT = 0,
	@VersionID INT = 0,
...
EXEC [spPortalGet_CreateTableScript] @UserID=-10, @Debug = 1, @DBName = 'tempdb',		@SchemaName = 'dbo', @TableName = '##sega1', @SQLScript_OUT = @SQLScript_Result OUTPUT
select @SQLScript_Result
EXEC [spPortalGet_CreateTableScript] @UserID=-10, @Debug = 1, @DBName = 'pcDATA_SCCWA',	@SchemaName = 'dbo', @TableName = 'DS_Account', @SQLScript_OUT = @SQLScript_Result OUTPUT
select @SQLScript_Result
EXEC [spPortalGet_CreateTableScript] @UserID=-10, @Debug = 1, @DBName = 'pcINTEGRATOR',	@SchemaName = 'dbo', @TableName = 'Job', @SQLScript_OUT = @SQLScript_Result OUTPUT
select @SQLScript_Result

EXEC [spPortalGet_CreateTableScript] @GetVersion = 1
*/
