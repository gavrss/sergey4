...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spIU_DC_Journal_OpeningBalance]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
EXEC [pcINTEGRATOR].[dbo].[spIU_DC_Journal_OpeningBalance] 
@UserID='-10',@InstanceID='996',@VersionID='1394',@Book='MAIN',@Entity_MemberKey='166971',
@FiscalYear='2026', @DebugBM = 7
...
BEGIN TRY
	...
	SET @Step = 'Set procedure variables'
		...
		IF @DebugBM & 2 > 0 SELECT [@InstanceID] = @InstanceID, [@EntityID] = @EntityID, [@JournalTable] = @JournalTable
	...
	SET @Step = 'Create and fill temp table #FiscalPeriod'
		...
		IF  @InstanceID = 603 AND @VersionID = 1095 AND @Entity_MemberKey = 'Honematic' AND @Book = 'GL' AND @FiscalYear = 2020
			...
			UNION SELECT [FiscalYear] = 2020, [FiscalPeriod] = 1, [YearMonth] = 201912
		...
		ELSE IF  @InstanceID = 603 AND @VersionID = 1095 AND @Entity_MemberKey = 'Honematic' AND @Book = 'GL' AND @FiscalYear = 2021
			INSERT INTO #FiscalPeriod
				(
				[FiscalYear],
				[FiscalPeriod],
			...
			UNION SELECT [FiscalYear] = 2021, [FiscalPeriod] = 1, [YearMonth] = 202012
		...
		ELSE IF @InstanceID = 603 AND @VersionID = 1095 AND @Entity_MemberKey = 'Honematic' AND @Book = 'GL' 
		AND @FiscalYear = 2022
			INSERT INTO #FiscalPeriod
				(
				[FiscalYear],
