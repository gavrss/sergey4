...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalGet_DataClass_Data_testNeha]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
AS
/*
EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data_testNeha] @DebugBM=3,@ResultTypeBM='132',
@ActingAs='5892',@AssignmentID='21128',@DataClassID='5795',
@Filter='Flow=NONE|Time=2023|Scenario=BUDGET|Entity=DLMAC|Currency=MXN|Account=All_|FullAccount=Balance_Sheet_|BusinessProcess=INPUT|BusinessRule=NONE|Version=NONE',
@GroupBy='Time|FullAccount',@Hierarchy='FullAccount:1',@InstanceID='596',@Measure='Financials',
@RowList='SupressZeroYN=0',@UseCacheYN='true',@UserID='7881',@VersionID='1091'
