...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalGet_DataClass_Data_20230616_neha]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
AS
/*
EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data_20230616_neha] @ActingAs='5973',@DataClassID='5872',
@Filter='Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=GBP|Version=NONE|GL_CostCentre=All_|GL_Product=All_|GL_Project=All_|LineItem=All_|FullAccount:1=EBIT',
@GroupBy='Account|Entity',@InstanceID='621',@ResultTypeBM='512',@RowList='SupressZeroYN=1|Account=All_',
@Tuple='#Tuple=actual-202109|Time=202109|Scenario=ACTUAL|TimeView=Periodic;#Tuple=actual-202110|Time=202110|Scenario=ACTUAL|TimeView=Periodic;#Tuple=actual-202111|Time=202111|Scenario=ACTUAL|TimeView=Periodic;#Tuple=actual-202112|Time=202112|Scenario=ACTUAL|TimeView=Periodic;#Tuple=actual-202201|Time=202201|Scenario=ACTUAL|TimeView=Periodic;#Tuple=actual-202202|Time=202202|Scenario=ACTUAL|TimeView=Periodic;#Tuple=actual-202203|Time=202203|Scenario=ACTUAL|TimeView=Periodic;#Tuple=actual-202204|Time=202204|Scenario=ACTUAL|TimeView=Periodic;#Tuple=actual-202205|Time=202205|Scenario=ACTUAL|TimeView=Periodic;#Tuple=actual-202206|Time=202206|Scenario=ACTUAL|TimeView=Periodic;#Tuple=actual-202207|Time=202207|Scenario=ACTUAL|TimeView=Periodic;#Tuple=actual-202208|Time=202208|Scenario=ACTUAL|TimeView=Periodic;#Tuple=actual-py|Time=FY2021|Scenario=ACTUAL|TimeView=Periodic',
@UseCacheYN='true',@UserID='14572',@VersionID='1105',@DebugBM=16
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2197' SET @Description = 'Improved handling of Info Message.'
