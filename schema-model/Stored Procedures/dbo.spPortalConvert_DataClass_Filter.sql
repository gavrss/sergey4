...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalConvert_DataClass_Filter]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
AS
/*
EXEC [pcINTEGRATOR].[dbo].[spPortalConvert_DataClass_Filter] @DebugBM=15, @DataClassID=N'5876',@InstanceID=N'622',@ResultTypeBM=N'37',@Rows=N'500',@UserID=N'14791',@VersionID=N'1106'
,@JSON_table='[{"TKey":"Account","TValue":"1020"},{"TKey":"Entity","TValue":"162536"},{"TKey":"Description","TValue":"KONDEX CORPORATION"},
{"TKey":"LineItem","TValue":"All_"},{"TKey":"Time","TValue":"All_"},{"TKey":"BusinessRule","TValue":"All_"},{"TKey":"Flow","TValue":"All_"},
{"TKey":"Scenario","TValue":"ACTUAL"},{"TKey":"FiscalPeriod","TValue":"202301"},{"TKey":"Version","TValue":"NONE"},{"TKey":"Currency","TValue":"USD"},
{"TKey":"Measure","TValue":"Financials"},{"TKey":"TimeView","TValue":"Periodic"},{"TKey":"GL_Department","TValue":"All_"},{"TKey":"BusinessProcess","TValue":"CONSOLIDATED"}]
'

EXEC [pcINTEGRATOR].[dbo].[spPortalConvert_DataClass_Filter] @DebugBM=15, @DataClassID=N'6095',@InstanceID=N'690',@ResultTypeBM=N'37',@UserID=N'28595',@VersionID=N'1141'
,@JSON_table='[{"TKey":"Account","TValue":"1000000"},{"TKey":"Entity","TValue":"017056"},{"TKey":"Description","TValue":"PARR LUMBER COMPANY"},
{"TKey":"GL_Branch","TValue":"All_"},{"TKey":"LineItem","TValue":"All_"},{"TKey":"Time","TValue":"202401"},{"TKey":"BusinessRule","TValue":"NONE"},
{"TKey":"Flow","TValue":"All_"},{"TKey":"Scenario","TValue":"ACTUAL"},{"TKey":"Version","TValue":"NONE"},{"TKey":"Currency","TValue":"USD"},
{"TKey":"Measure","TValue":"Financials"},{"TKey":"TimeView","TValue":"Periodic"},{"TKey":"GL_Department","TValue":"All_"},{"TKey":"BusinessProcess","TValue":"CONSOLIDATED"}]'

Invalid column name 'TimeView'.
EXEC [spRun_Procedure_KeyValuePair] @ProcedureName='spPortalConvert_DataClass_Filter', @JSON='[{"TKey":"DebugBM","TValue":"15"},
{"TKey":"UserID","TValue":"18957"},{"TKey":"InstanceID","TValue":"-1662"},{"TKey":"VersionID","TValue":"-1662"},{"TKey":"DataClassID","TValue":"19003"},
{"TKey":"ResultTypeBM","TValue":"36"},{"TKey":"Rows","TValue":"500"}]', @JSON_table='[{"TKey":"Group","TValue":"All_"},{"TKey":"Account","TValue":"4000"},
{"TKey":"Entity","TValue":"EPIC03"},{"TKey":"Description","TValue":"Epicor USA"},{"TKey":"Customer","TValue":"All_"},{"TKey":"GL_Reference_Type","TValue":"All_"},
{"TKey":"LineItem","TValue":"NONE"},{"TKey":"Time","TValue":"202101"},{"TKey":"BusinessRule","TValue":"All_"},{"TKey":"Scenario","TValue":"ACTUAL"},
{"TKey":"Flow","TValue":"All_"},{"TKey":"GL_Division","TValue":"All_"},{"TKey":"Version","TValue":"NONE"},{"TKey":"Currency","TValue":"USD"},
{"TKey":"Measure","TValue":"Financials"},{"TKey":"Supplier","TValue":"All_"},{"TKey":"TimeView","TValue":"Periodic"},{"TKey":"GL_Department","TValue":"All_"},
{"TKey":"BusinessProcess","TValue":"CONSOLIDATED"}]'

DECLARE @JSON_table_Value NVARCHAR(max) = '
[{"TKey":"Account","TValue":"430000"},{"TKey":"Entity","TValue":"ACF_I"},{"TKey":"Description","TValue":"Arbor Commercial Funding I LLC"},{"TKey":"GL_State","TValue":"All_"},{"TKey":"LineItem","TValue":"All_"},{"TKey":"Time","TValue":"202101"},{"TKey":"BusinessRule","TValue":"All_"},{"TKey":"Flow","TValue":"All_"},{"TKey":"Scenario","TValue":"ACTUAL"},{"TKey":"GL_Product","TValue":"All_"},{"TKey":"GL_Loan_Number","TValue":"All_"},{"TKey":"Version","TValue":"NONE"},{"TKey":"Currency","TValue":"USD"},{"TKey":"Measure","TValue":"Financials"},{"TKey":"GL_Department","TValue":"All_"},{"TKey":"BusinessProcess","TValue":"CONSOLIDATED"}]'
EXEC [pcINTEGRATOR].[dbo].[spPortalConvert_DataClass_Filter] @DataClassID='5657',@InstanceID='559',@ResultTypeBM='4',@UserID='9764',@VersionID='1069',@JSON_table=@JSON_table_Value, @DebugBM=15

-- journal data
 EXEC spRun_Procedure_KeyValuePair @ProcedureName='spPortalConvert_DataClass_Filter',@JSON='[{"TKey":"DebugBM","TValue":"15"},
 {"TKey":"UserID","TValue":"9411"},{"TKey":"InstanceID","TValue":"428"},{"TKey":"VersionID","TValue":"1053"},
 {"TKey":"DataClassID","TValue":"5539"},{"TKey":"ResultTypeBM","TValue":"36"},{"TKey":"Rows","TValue":"500"}]',
 @JSON_table='[{"TKey":"TimeFiscalPeriod","TValue":"All_"},{"TKey":"Account","TValue":"320002"},
 {"TKey":"Entity","TValue":"1"},{"TKey":"GL_Posted","TValue":"All_"},{"TKey":"Description","TValue":"01  PltGBROS  GOTWALS BROTHERS"},
 {"TKey":"GL_Location","TValue":"All_"},{"TKey":"LineItem","TValue":"All_"},{"TKey":"Time","TValue":"All_"},
 {"TKey":"BusinessRule","TValue":"All_"},{"TKey":"FiscalPeriod","TValue":"202101"},{"TKey":"Scenario","TValue":"ACTUAL"},
 {"TKey":"Flow","TValue":"All_"},{"TKey":"Version","TValue":"NONE"},{"TKey":"Currency","TValue":"US "},
 {"TKey":"Measure","TValue":"Financials"},{"TKey":"GL_Department","TValue":"All_"},{"TKey":"BusinessProcess","TValue":"CONSOLIDATED"}]'

 -- journal filters
 EXEC spRun_Procedure_KeyValuePair @ProcedureName='spPortalConvert_DataClass_Filter',@JSON='[{"TKey":"DebugBM","TValue":"3"},
 {"TKey":"UserID","TValue":"9411"},{"TKey":"InstanceID","TValue":"428"},{"TKey":"VersionID","TValue":"1053"},
 {"TKey":"DataClassID","TValue":"5539"},{"TKey":"ResultTypeBM","TValue":"3"}]',
 @JSON_table='[{"TKey":"TimeFiscalPeriod","TValue":"All_"},{"TKey":"Account","TValue":"320002"},
 {"TKey":"Entity","TValue":"1"},{"TKey":"GL_Posted","TValue":"All_"},{"TKey":"Description","TValue":"01  PltGBROS  GOTWALS BROTHERS"},
 {"TKey":"GL_Location","TValue":"All_"},{"TKey":"LineItem","TValue":"All_"},{"TKey":"Time","TValue":"All_"},
 {"TKey":"BusinessRule","TValue":"All_"},{"TKey":"FiscalPeriod","TValue":"2021"},{"TKey":"Scenario","TValue":"ACTUAL"},
 {"TKey":"Flow","TValue":"All_"},{"TKey":"Version","TValue":"NONE"},{"TKey":"Currency","TValue":"US "},
 {"TKey":"Measure","TValue":"Financials"},{"TKey":"GL_Department","TValue":"All_"},{"TKey":"BusinessProcess","TValue":"CONSOLIDATED"}]'

EXEC spRun_Procedure_KeyValuePair
	@ProcedureName = 'spPortalConvert_DataClass_Filter',
	@JSON = '
		[
		{"TKey":"UserID", "TValue":"3813"},
		{"TKey":"InstanceID", "TValue":"413"},
		{"TKey":"VersionID", "TValue":"1008"},
		{"TKey":"DataClassID", "TValue":"1028"},
		{"TKey":"Rows", "TValue":"100"},
		{"TKey":"ResultTypeBM", "TValue":"39"}
		]',
	@JSON_table = '
		[
		{"TKey":"Account", "TValue":"746000"},
		{"TKey":"Currency", "TValue":"USD"},
		{"TKey":"Entity", "TValue":"1"},
		{"TKey":"GL_Department", "TValue":"SC40"},
		{"TKey":"Scenario", "TValue":"ACTUAL"},
		{"TKey":"Time", "TValue":"201408"},
		{"TKey":"TimeDataView", "TValue":"Periodic"}
		]'

EXEC [spPortalConvert_DataClass_Filter] @GetVersion = 1
*/
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2199' SET @Description = 'Updated to latest sp template. FPA-357: Added filter on enabled Entities ONLY when setting @Book.' 
	...
	SET @Step = 'Set @Entity and @Book'
		...
		IF CHARINDEX('_', @Entity) = 0 OR 
			...
			FROM
				...
				INNER JOIN [pcINTEGRATOR_Data].[dbo].[Entity_Book] EB ON EB.InstanceID = E.InstanceID AND EB.EntityID = E.EntityID AND EB.BookTypeBM & 2 > 0 AND EB.SelectYN <> 0
			WHERE
				E.InstanceID = @InstanceID AND
				E.VersionID = @VersionID AND
				E.MemberKey = @Entity AND
	...
	SET @Step = 'Set FiscalYear'
		...
		IF @DebugBM & 2 > 0	
			BEGIN
				...
				JOIN  [pcINTEGRATOR_Data].[dbo].DataClass_Dimension DCD ON	DCD.DataClassID = COALESCE (@DataClassID, DCD.DataClassID) 
																		AND DCD.DimensionID = DF.DimensionID
				WHERE DF.DimensionID IN (-7, -49, -76) 
		...
		ELSE IF @ResultTemplate = 'Generic'
			BEGIN
				...
				SET @SQLStatement = '
					...
					WHERE
						[name] = ''spPortalGet_' + @DataClassName + '_Drill_HC'''
				...
				IF @CheckExistence <> 0
					BEGIN
						...
						SET @SQLStatement = '[' + @ETLDatabase + '].[dbo].[spPortalGet_' + @DataClassName + '_Drill_HC] @UserID = ' + CONVERT(nvarchar(15), @UserID) + ', @InstanceID = ' + CONVERT(nvarchar(15), @InstanceID) + ', @VersionID = ' + CONVERT(nvarchar(15), @VersionID) + ', @ResultTypeBM = ' + CONVERT(nvarchar(15), @ResultTypeBM) + CASE WHEN @Rows IS NOT NULL THEN ', @Rows = ' + CONVERT(nvarchar(15), @Rows) ELSE '' END + ', @JobID = ' + CONVERT(nvarchar(15), @JobID) + ', @Debug = ' + CONVERT(nvarchar(15), @DebugSub)
						IF @DebugBM & 2 > 0 PRINT @SQLStatement
						EXEC (@SQLStatement)
					END
				ELSE
