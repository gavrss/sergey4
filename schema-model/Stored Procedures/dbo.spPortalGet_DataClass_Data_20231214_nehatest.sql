...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalGet_DataClass_Data_20231214_nehatest]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data_20231214_nehatest] @DataClassID='6068',@InstanceID='677',@ResultTypeBM='512',@UseCacheYN='true',@UserID='28443',@VersionID='1135',
@Filter='TimeView=Periodic|Account=SalesAmount_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=USD|Entity=US00|Scenario=ACTUAL|AccountManager=All_|CurrentOrderState=All_|InvoiceNo_AR=All_|OrderLine=All_|OrderNo=All_|OrderState=60|Product=All_',
@RowList='SupressZeroYN=1|Customer=All_',@Tuple='#Tuple=304214fa-b39e-4e27-b685-a62d0a3d7501|TimeDay=202301',@DebugBM=15

EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @ActingAs='3187',@DataClassID='5578',
@Filter='Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=All_|Entity=All_|Scenario=All_|Time=202310|Version=NONE|LineItem=All_|GL_Customer=All_|GL_Department=All_|GL_Division=All_|GL_Employee=All_|GL_Reference_Type=All_|FullAccount=All_',
@InstanceID='534',@ResultTypeBM='512',@RowList='SupressZeroYN=1|Account=Income_Statement_',@Tuple='#Tuple=57262e60-9f57-4405-a53d-80ad427fd9c5|TimeView=Periodic',@UseCacheYN='true',@UserID='9865',@VersionID='1060',@DebugBM=63

EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @ActingAs='3187',@DataClassID='5578',@Filter='Account=Income_Statement_|Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=All_|Entity=All_|Version=NONE|LineItem=All_|GL_Customer=All_|GL_Division=All_|GL_Employee=All_|GL_Reference_Type=All_|FullAccount=All_',
@InstanceID='534',@ResultTypeBM='256',@RowList='GL_Department=10',@Tuple='#Tuple=actual|Time=202310|Scenario=ACTUAL|TimeView=Periodic;#Tuple=budget|Time=202310|Scenario=BUDGET|TimeView=Periodic',@UseCacheYN='true',@UserID='9865',@VersionID='1060',@DebugBM=63

EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data_20231003_nehatest] @ActingAs='5973',@DataClassID='5872',@InstanceID='621',@UseCacheYN='true',@UserID='14572',@VersionID='1105',@DebugBM=31,
@Filter='Account=All_|Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=GBP|Entity=PGLGroupTotal|Version=NONE|GL_CostCentre=AP_CaythorpeCourt|GL_Product=All_|GL_Project=All_|LineItem=All_',
@ResultTypeBM='512',@RowList='SupressZeroYN=1|FullAccount:All_',@Tuple='#Tuple=actual|Time=202304|Scenario=ACTUAL|FullAccount:1=180|TimeView=Periodic;#Tuple=budget|Time=202304|Scenario=BUDGET|FullAccount:1=180|TimeView=Periodic'


EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @DebugBM=7,@ActingAs='5715',@DataClassID='5764',
@Filter='TimeView=Periodic|Account=ACM_PatientFlight|Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=USD|Entity=61349|Scenario=BGT23|Time=202307|Version=NONE|GL_Company=All_|GL_Department=All_|GL_Division=All_|GL_Line_of_Service=All_|GL_Posted=All_|GL_Reference=All_|GL_Region=All_|GL_Unit=All_',
@GroupBy='Scenario|FullAASI',@Hierarchy='Account=7',@InstanceID='568',@Measure='Financials',@ResultTypeBM='4',
@RowList='SupressZeroYN=1',@UseCacheYN='false',@UserID='9886',@VersionID='1077'

EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @DebugBM=19, @DataClassID='5764',
@Filter='TimeView=Periodic|Account=10000|Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=USD|Entity=61349|Scenario=ACTUAL|Time=202308|Version=NONE|GL_Company=All_|GL_Department=All_|GL_Division=All_|GL_Line_of_Service=All_|GL_Posted=All_|GL_Reference=All_|GL_Region=All_|GL_Unit=All_|FullAASI=05-0041-0000-0000',
@GroupBy='Scenario|Account',@Hierarchy='Account=7',@InstanceID='568',@Measure='Financials',@ResultTypeBM='4',
@RowList='SupressZeroYN=0',@UseCacheYN='false',@UserID='7881',@VersionID='1077'

EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @DebugBM=7,@ActingAs='5715',@DataClassID='5764',
@Filter='TimeView=Periodic|Account=ACM_PatientFlight|Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=USD|Entity=61349|Scenario=BGT23|Time=202307|Version=NONE|GL_Company=All_|GL_Department=All_|GL_Division=All_|GL_Line_of_Service=All_|GL_Posted=All_|GL_Reference=All_|GL_Region=All_|GL_Unit=All_',
@GroupBy='Scenario|FullAASI',@Hierarchy='Account=7',@InstanceID='568',@Measure='Financials',@ResultTypeBM='4',@RowList='SupressZeroYN=1',@UseCacheYN='false',@UserID='9886',@VersionID='1077'

EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @DebugBM=0,@ActingAs='5606',@DataClassID='5718',@UseCacheYN='false',@UserID='9911',@VersionID='1081',@InstanceID='574',@ResultTypeBM='256',
@Filter='TimeView=Periodic|Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=USD|Entity=All_|Scenario=ACTUAL|Time=202306|Version=NONE|LineItem=All_|GL_Department=All_|GL_Entity=All_|GL_Interco=ICONone|GL_Organization=All_|FullAccount=All_',
@RowList='Account=Gross_Sales,Sales_Ret_Disc_Allow,Interco_Sales,I_Tot_Dir_Mat,I_Dir_Mat,I_Mat_PPV,I_Mat_Var,I_Scrap,I_Freight_In,I_Ind_Mat,I_OS_Prov,I_DL_Var,I_DL_Absor,I_DL_COGS,I_Suppl,I_Freight_Out,I_Inv_Adj,I_Tool,I_VAT,I_OH_Var,I_OH_Absor,I_OH_COGS,I_Oth_Amort,I_Oth_Mgmt_Fees,I_Oth_Oth_Exp,999999,512030,670020,I_Oth_NR,I_Oth_MA,I_Oth_Integ_Exp,Income_Statement_',
@Tuple='#Tuple=months|Time=202306;#Tuple=1ba81fee-03a6-41e7-9e4d-f1f323ab675f|Time=202305;#Tuple=c17420a5-e794-4cc1-8690-b47d3e08b962|Time=202304;#Tuple=4bcb94d5-fb30-4a15-b7f3-68ba749874ea|Time=202303;#Tuple=2ed74e6a-e4cc-4352-b498-739eaf439631|Time=202302;#Tuple=3afbbd5e-6b25-4c41-af05-28961b46ba5b|Time=202301;#Tuple=691c396b-144a-4666-9bb8-b4d2125c5113|Time=202212;#Tuple=cbe75e35-0d71-428c-9299-3ec834f5fa28|Time=202211;#Tuple=27c624dd-a5a1-4237-8976-c2bb611516ed|Time=202210;#Tuple=2b5cc705-a1f1-4368-9475-71167d5712e1|Time=202209;#Tuple=b1e26437-05ed-429c-a09a-22dea2145326|Time=202208;#Tuple=0384f416-e887-4b65-9c0b-1e0cfafd19cc|Time=202207;#Tuple=actual|Time=202207,202208,202209,202210,202211,202212,202301,202302,202303,202304,202305,202306'

EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @DebugBM='0',@DataClassID='5764',@UseCacheYN='false',@UserID='10153',@VersionID='1077',@InstanceID='568',@ResultTypeBM='256',
@Filter='Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=NONE|Currency=USD|Entity=61349|Version=NONE|LineItem=All_|GL_Company=All_|GL_Department=All_|GL_Division=All_|GL_Line_of_Service=All_|GL_Posted=All_|GL_Reference=All_|GL_Region=All_|GL_Unit=All_',
@RowList='Account:6=ACM_MembershipRevenue,ACM_GrndPatRev,ACM_UppPaymntLmtRev,ACM_ProviderTax,ACM_TennProviderTax,ACM_GroundCntrcts,ACM_VanContracts,ACM_VanCntrctsFeeFrServ,ACM_BDRecov,ACM_BDAllowGnd,ACM_CntrctAllwMCMAGrnd,ACM_AirPatRev,ACM_AirServFixWng,ACM_BDAllowAir,ACM_CntrctAllwMcMaAir,ACM_MiscellaneousRevenue,ACM_ATS_Retail,ACM_ATS_AcadianOnWatch,ACM_ATS_MMonit,ACM_ATS_AcadianOnCalll,ACM_ATS_AOCEquipSales,ACM_EmpHospins,FixedWingExpen,HelicExpen,ACM_PyrllTax,ACM_RentEquip,ACM_RepOthElec,ACM_Salaries,ACM_IntrstExp,ACM_Depreciation,ACM_AmortSub,ACM_StateTaxes,ACM_ESOPExpContr,ACM_EmpPensPlan,ACM_EmpStkOptExp,99998|Account=ACM_MobileHealthCare,ACM_InvestmentIncome,AC_561,ACM_CLafou,ACM_StJamesParish,ACM_IbervilleParishContract,ACM_StJohnParishContract,ACM_LiveOakCounty,ACM_SMSSaleofMedicalEquip,ACM_SMSLabor,ACM_SMSEquipment,ACM_SMSReimbursement,ACM_EMSAcademy,ACM_AccountServ,ACM_AdvCampaign,ACM_AdvReg,ACM_AttFees,ACM_BadExpense,ACM_BanExpense,ACM_BuildMaint,ACM_ColFee,ACM_CompServ,ACM_ComSupplies,ACM_Contr,ACM_DuesSubsc,ACM_Educa,ACM_Travel,ACM_TraveReimb,ACM_PromoAndDevel,ACM_EmpUni,ACM_ESOPAdmin,ACM_EmpExp,ACM_InsExp,ACM_LaundLin,ACM_LinenDisp,ACM_LeaseAuto,ACM_LeaseCommEqip,ACM_MedicSuppl,ACM_ItmsResale,ACM_WirlssServFee,ACM_DocShred,ACM_MoniServ,ACM_Misc,ACM_OffficeSupp,ACM_OfficLifeInsur,ACM_OtherSuppl,ACM_Postage,ACM_Printing,ACM_ProfeServi,ACM_RentBuildAnd,ACM_CntrctLbr,ACM_TaxesLicen,ACM_Tele,ACM_TeleMobile,ACM_TowRent,ACM_TrainMatSupp,ACM_Utili,ACM_MileaReimb,ACM_VehicExpGasOil,ACM_VehicExpRepairs,ACM_VehicExpTirBat,ACM_XeroxMachSupp,99999,All_|Account:7=WestTexasAmbul,ContrMcr,BadDebtAllow',
@Tuple='#Tuple=e83ae174-b160-4fef-9b93-684066a778ae|Time=202305|FullAASI=Conso|Scenario=BGT23|TimeView=YTD;#Tuple=actual|Time=202305|FullAASI=Conso|Scenario=ACTUAL|TimeView=YTD;#Tuple=5439eea1-96d6-45a1-83ec-1b74fe470368-AmbulServi|Time=202301,202302,202303,202304,202305|FullAASI=AmbulServi|Scenario=ACTUAL|TimeView=Periodic;#Tuple=5439eea1-96d6-45a1-83ec-1b74fe470368-VanServ|Time=202301,202302,202303,202304,202305|FullAASI=VanServ|Scenario=ACTUAL|TimeView=Periodic;#Tuple=5439eea1-96d6-45a1-83ec-1b74fe470368-AcadiHealt|Time=202301,202302,202303,202304,202305|FullAASI=AcadiHealt|Scenario=ACTUAL|TimeView=Periodic;#Tuple=5c0a6aca-4742-415b-b858-cd053229e5d4-AirMed|Time=202301,202302,202303,202304,202305|FullAASI=AirMed|Scenario=ACTUAL|TimeView=Periodic;#Tuple=5c0a6aca-4742-415b-b858-cd053229e5d4-FixedWing|Time=202301,202302,202303,202304,202305|FullAASI=FixedWing|Scenario=ACTUAL|TimeView=Periodic;#Tuple=58fc0034-ce58-4f83-a277-4905409194f6|Time=202301,202302,202303,202304,202305|FullAASI=ATS|Scenario=ACTUAL|TimeView=Periodic;#Tuple=ef5be66a-afba-4a90-bb06-8115e655c3e2|Time=202301,202302,202303,202304,202305|FullAASI=EMSAcad|Scenario=ACTUAL|TimeView=Periodic;#Tuple=8fe58263-25c0-49a6-a202-59ff48a3a77b|Time=202301,202302,202303,202304,202305|FullAASI=SMS|Scenario=ACTUAL|TimeView=Periodic;#Tuple=7fbdaf05-7410-4bc6-81a1-e5dbf3087c1e|Time=202301,202302,202303,202304,202305|FullAASI=ELIM|Scenario=ACTUAL|TimeView=Periodic;#Tuple=6278eb16-8a5b-46e9-ab88-f34714869dc0|Time=202301,202302,202303,202304,202305|FullAASI=Other|Scenario=ACTUAL|TimeView=Periodic;#Tuple=4b8d6d46-6c14-4dbc-a8f9-a5f06433480e|Time=202301,202302,202303,202304,202305|FullAASI=SuppDepts|Scenario=ACTUAL|TimeView=Periodic'
--@RowList='Account:6=ACM_MembershipRevenue,ACM_GrndPatRev,ACM_UppPaymntLmtRev,ACM_ProviderTax,ACM_TennProviderTax',
--@Tuple='#Tuple=e83ae174-b160-4fef-9b93-684066a778ae|Time=202305|FullAASI=Conso|Scenario=BGT23|TimeView=YTD;#Tuple=actual|Time=202305|FullAASI=Conso|Scenario=ACTUAL|TimeView=YTD;#Tuple=5439eea1-96d6-45a1-83ec-1b74fe470368-AmbulServi|Time=202301,202302,202303,202304,202305|FullAASI=AmbulServi|Scenario=ACTUAL|TimeView=Periodic'

EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @DataClassID='5764',@InstanceID='568',@ResultTypeBM='256',@UseCacheYN='false',@UserID='7881',@VersionID='1077',@DebugBM=0,
@Filter='TimeView=Periodic|Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=USD|Entity=61349|Scenario=ACTUAL|Time=202305|Version=NONE|LineItem=All_|GL_Company=All_|GL_Department=All_|GL_Division=All_|GL_Line_of_Service=All_|GL_Posted=All_|GL_Reference=All_|GL_Region=All_|GL_Unit=All_|FullAASI=AirMed',
@RowList='Account:6=ACM_LinenDisp',
@Tuple='#Tuple=923509f5-735b-4a13-994c-9ca2b892454c|FullAASI=AirMed|Scenario=ACTUAL|Time=202301,202302,202303,202304,202305|TimeView=Periodic;#Tuple=5439eea1-96d6-45a1-83ec-1b74fe470368-AM1LAF|FullAASI=AM1LAF|Scenario=ACTUAL|Time=202305|TimeView=YTD;#Tuple=5439eea1-96d6-45a1-83ec-1b74fe470368-AM2HMA|FullAASI=AM2HMA|Scenario=ACTUAL|Time=202305|TimeView=YTD;#Tuple=5439eea1-96d6-45a1-83ec-1b74fe470368-AM3BR|FullAASI=AM3BR|Scenario=ACTUAL|Time=202305|TimeView=YTD'
--@Tuple='#Tuple=923509f5-735b-4a13-994c-9ca2b892454c|FullAASI=AirMed|Scenario=ACTUAL|Time=202301,202302,202303,202304,202305|TimeView=Periodic'
--@Tuple='#Tuple=923509f5-735b-4a13-994c-9ca2b892454c|FullAASI=AirMed|Scenario=ACTUAL|Time=202301,202302,202303,202304,202305|TimeView=Periodic;#Tuple=5439eea1-96d6-45a1-83ec-1b74fe470368-AM1LAF|FullAASI=AM1LAF|Scenario=ACTUAL|Time=202305|TimeView=YTD;#Tuple=5439eea1-96d6-45a1-83ec-1b74fe470368-AM2HMA|FullAASI=AM2HMA|Scenario=ACTUAL|Time=202305|TimeView=YTD'
--@Tuple='#Tuple=5439eea1-96d6-45a1-83ec-1b74fe470368-AM1LAF|FullAASI=AM1LAF|Scenario=ACTUAL|Time=202305|TimeView=YTD;#Tuple=5439eea1-96d6-45a1-83ec-1b74fe470368-AM2HMA|FullAASI=AM2HMA|Scenario=ACTUAL|Time=202305|TimeView=YTD'


EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @ActingAs='5686',@DataClassID='5817',
@Filter='Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=All_|Entity=All_|Version=NONE|LineItem=All_|GL_Cost_Centre=Residential_Care|GL_Project=All_|GL_Project_Child=All_|ReferenceType=All_',
@InstanceID='617',@ResultTypeBM='512',@RowList='SupressZeroYN=1|Account=Income_Statement_',
@Tuple='#Tuple=budget|Time=FY2024|Scenario=BUDGET|TimeView=Periodic;#Tuple=518b873e-d191-458d-af69-ea971bb4c12a|Time=FY2023|Scenario=FORECAST|TimeView=Periodic;#Tuple=budget-ytd|Time=FY2023|Scenario=BUDGET|TimeView=Periodic',
@UseCacheYN='true',@UserID='10212',@VersionID='1091',@DebugBM=16


EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @ActingAs='5625',@AssignmentID='21098',@DataClassID='5788',
@Filter='Time=FY2023|Scenario=BUDGET|Entity=',@GroupBy='Time|Currency|Rate',@InstanceID='583',@Measure='FxRate',
@ResultTypeBM='204',@RowList='SupressZeroYN=0',@UseCacheYN='true',@UserID='-1571',@VersionID='1083'

EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @ActingAs='5625',@AssignmentID='21098',@DataClassID='5788'
,@Filter='BaseCurrency=AUD|Time=FY2023|Scenario=BUDGET|Rate=All_|Entity=|Currency=All_',@GroupBy='Time|Currency|Rate'
,@InstanceID='583',@Measure='FxRate',@ResultTypeBM='204',@RowList='SupressZeroYN=0',@UseCacheYN='true',@UserID='-1571'
,@VersionID='1083',@DebugBM=31
...
,{"TKey" : "DataClassID", "TValue" : "5713"},{"TKey" : "ResultTypeBM", "TValue" : "8"},{"TKey" : "GroupBy", "TValue" : "Time|Account|Entity|GL_Branch"}
,{"TKey" : "Measure", "TValue" : "Financials"},{"TKey" : "AssignmentID", "TValue" : "20593"}
,{"TKey" : "Filter", "TValue" : "FixedAsset=NONE|Group=NONE|Flow=NONE|Supplier=NONE|Customer=NONE|Time=FY2022|Scenario=F10|Entity=ZA01|Currency=ZAR|Account=0108|GL_CostCenter=05|GL_Branch=650|BusinessProcess=INPUT|BusinessRule=NONE|GL_Posted=TRUE|TimeDataView=RAWDATA|Version=NONE"}
,{"TKey" : "RowList", "TValue" : "SupressZeroYN=0"},{"TKey" : "ActingAs", "TValue" : "5573"},{"TKey" : "UseCacheYN", "TValue" : "true"}]'


EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @ActingAs='5531',@DataClassID='5670', @DebugBM=63,
@Filter='TimeView=Periodic|Flow=All_|BusinessProcess=All_|BusinessRule=All_|Currency=All_|Entity=All_|Scenario=All_|Time=2021|Version=NONE|LineItem=All_|GL_Department=All_|GL_Division=All_',@InstanceID='562',
@ResultTypeBM='512',@RowList='SupressZeroYN=0|Account=EFP_CEB',@Tuple='#Tuple=c3ff6fdc-a1df-468d-b853-79a5c04ae9f2-202101|Scenario=CF YTD|Time=202101;#Tuple=c3ff6fdc-a1df-468d-b853-79a5c04ae9f2-202102|Scenario=CF YTD|Time=202102;#Tuple=c3ff6fdc-a1df-468d-b853-79a5c04ae9f2-202103|Scenario=CF YTD|Time=202103;#Tuple=c3ff6fdc-a1df-468d-b853-79a5c04ae9f2-202104|Scenario=CF YTD|Time=202104;#Tuple=c3ff6fdc-a1df-468d-b853-79a5c04ae9f2-202105|Scenario=CF YTD|Time=202105;#Tuple=c3ff6fdc-a1df-468d-b853-79a5c04ae9f2-202106|Scenario=CF YTD|Time=202106;#Tuple=c3ff6fdc-a1df-468d-b853-79a5c04ae9f2-202107|Scenario=CF YTD|Time=202107;#Tuple=c3ff6fdc-a1df-468d-b853-79a5c04ae9f2-202108|Scenario=CF YTD|Time=202108;#Tuple=c3ff6fdc-a1df-468d-b853-79a5c04ae9f2-202109|Scenario=CF YTD|Time=202109;#Tuple=c3ff6fdc-a1df-468d-b853-79a5c04ae9f2-202110|Scenario=CF YTD|Time=202110;#Tuple=c3ff6fdc-a1df-468d-b853-79a5c04ae9f2-202111|Scenario=CF YTD|Time=202111;#Tuple=c3ff6fdc-a1df-468d-b853-79a5c04ae9f2-202112|Scenario=CF YTD|Time=202112;#Tuple=actual-202101|Scenario=ACTUAL|Time=202101;#Tuple=actual-202102|Scenario=ACTUAL|Time=202102;#Tuple=actual-202103|Scenario=ACTUAL|Time=202103;#Tuple=actual-202104|Scenario=ACTUAL|Time=202104;#Tuple=actual-202105|Scenario=ACTUAL|Time=202105;#Tuple=actual-202106|Scenario=ACTUAL|Time=202106;#Tuple=actual-202107|Scenario=ACTUAL|Time=202107;#Tuple=actual-202108|Scenario=ACTUAL|Time=202108;#Tuple=actual-202109|Scenario=ACTUAL|Time=202109;#Tuple=actual-202110|Scenario=ACTUAL|Time=202110;#Tuple=actual-202111|Scenario=ACTUAL|Time=202111;#Tuple=actual-202112|Scenario=ACTUAL|Time=202112;#Tuple=7e31b66b-b32e-40b7-b718-d442257b8f4b|Scenario=ACTUAL|Time=202210;#Tuple=b1502271-b2c2-4a88-b90a-49a5b22b2ffb|Scenario=FORECAST|Time=202210',@UseCacheYN='true',@UserID='9853',@VersionID='1072'

EXEC [spRun_Procedure_KeyValuePair] @ProcedureName='spPortalGet_DataClass_Data', @JSON='[{"TKey" : "DebugBM", "TValue" : "3"},
{"TKey" : "UserID", "TValue" : "10440"},{"TKey" : "InstanceID", "TValue" : "586"},{"TKey" : "VersionID", "TValue" : "1087"},
{"TKey" : "DataClassID", "TValue" : "5768"},{"TKey" : "ResultTypeBM", "TValue" : "64"},
{"TKey" : "GroupBy", "TValue" : "Time|Account"},{"TKey" : "Measure", "TValue" : "Financials"},
{"TKey" : "AssignmentID", "TValue" : "21122"},{"TKey" : "Filter", "TValue" : "Flow=NONE|Time=2023|Scenario=BUDGET|Entity=99473|Currency=USD|Account=Financials_|GL_Company=10|GL_Department=48|GL_Product_Group=NONE|FullAccount=NONE|Version=NONE"},
{"TKey" : "ActingAs", "TValue" : "5845"},{"TKey" : "UseCacheYN", "TValue" : "true"}]'
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2199' SET @Description = 'DB-1631: Fix minor issue on @Tuple with only TimeView filter. DB-1638: In ResultypeBM = 8 (Changeable), return correct changeability value for WFS writeAccess state.'
				...
				DECLARE Tuple_Cursor CURSOR FOR
					...
					WHILE @@FETCH_STATUS = 0
						BEGIN
							...
							SELECT
								--@SQL_Tuple = @SQL_Tuple + CASE WHEN FT.[Method] IS NOT NULL THEN '[Time].[MemberId] ' ELSE 'DC.[' + FT.[DimensionName] + '_MemberID] ' END + FT.[EqualityString] + ' (' + FT.[LeafLevelFilter] + ') AND '
								@SQL_Tuple = @SQL_Tuple + CASE WHEN FT.[Method] IS NOT NULL OR FT.[DimensionName] = @TimeType THEN '[Time].[MemberId] ' ELSE 'DC.[' + FT.[DimensionName] + '_MemberID] ' END + FT.[EqualityString] + ' (' + FT.[LeafLevelFilter] + ') AND '
	...
	SET @Step = 'Get parts for SQL-statement'
		IF @ResultTypeBM & 812 > 0 --4, 8, 32, 64, 256, 512
			BEGIN
				...
				IF @DebugBM & 2 > 0
					SELECT
						Query = '@SQL_Select2 + @SQL_GroupBy2',
						GB.*
					FROM
						#GroupBy GB
							...
							SET @SQLMeasureList_8 = @SQLMeasureList_8 + CHAR(13) + CHAR(10) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9)+ CHAR(9) + @MeasureName + ' = ' + 
										...
										ELSE + 'CASE 
												WHEN MAX(WS.[WorkflowStateID]) IS NULL ' +	
														...
														THEN 'OR MAX([Time].[MemberId]) NOT BETWEEN MAX(ISNULL(WSS.[TimeFrom],-1)) AND MAX(ISNULL(WSS.[TimeTo],-1)) ' 
														ELSE '' 
														END + 
