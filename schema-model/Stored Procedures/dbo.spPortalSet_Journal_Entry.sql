...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalSet_Journal_Entry]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2199' SET @Description = 'DB-1635: Implement ResultTypeBM = 16 (Journal Lines and generate JournalHeader from Journal Line info). EA-8395: Removed ORDER By clause in @Step = Insert new rows. Handle ConsolidationGroup <> NONE.'
