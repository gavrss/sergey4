...
SET ANSI_NULLS ON
GO
create PROCEDURE [dbo].[spRun_Job_Callisto_Generic_20250506]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2199' SET @Description = 'Set @ParallelJob# = 25 and check for current session in table msdb.dbo.syssessions. Added parameter @JobID when calling [spSet_JobQueue]. Increased @ParallelJob# = 50.'
