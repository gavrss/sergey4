...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spIU_Dim_AccountCategory_Raw_20230627_neha]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
AS
/*
EXEC [pcINTEGRATOR].[dbo].[spIU_Dim_AccountCategory_Raw_20230627_neha] @DebugBM='7',@InstanceID='621',@UserID='-10',@VersionID='1105',@SourceTypeID=3,@SourceDatabase='dspsource04.PGL_ScaSystemDB'
