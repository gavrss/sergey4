...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spIU_DC_Financials_Raw_Test]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
SELECT * INTO pcETL_AAHD..tmp_Comb FROM #Comb 
SELECT * INTO pcETL_AAHD..tmp_Journal FROM #Journal
SELECT * INTO pcETL_AAHD..tmp_YM FROM #YM  
SELECT * INTO pcETL_AAHD..tmp_Flow FROM #Flow
