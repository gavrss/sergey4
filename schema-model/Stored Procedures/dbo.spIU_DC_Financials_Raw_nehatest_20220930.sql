...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spIU_DC_Financials_Raw_nehatest_20220930]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
AS
/*
EXEC [pcINTEGRATOR].[dbo].[spIU_DC_Financials_Raw_nehatest_20220930] @Book='MainBook',@ConsolidationGroupYN='0',@DebugBM='3'
,@Entity='TnMat',@FieldTypeBM='1',@FiscalYear='2022',@InstanceID='580',@JournalTable='[pcETL_WWL].[dbo].[Journal]',@Scenario='ACTUAL',@SequenceBM='3',@UserID='-10',@VersionID='1084'
