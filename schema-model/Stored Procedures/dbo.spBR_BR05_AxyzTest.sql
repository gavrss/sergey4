...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spBR_BR05_AxyzTest]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
EXEC [spBR_BR05_AxyzTest] @UserID=-10, @InstanceID=576, @VersionID=1082, @BusinessRuleID = 2717, @FiscalYear = 2021, @ConsolidationGroup = 'G_AXYZ', @DebugBM=0, @Entity_MemberKey = '105'
EXEC [spBR_BR05] @UserID=-10, @InstanceID=576, @VersionID=1082, @BusinessRuleID = 2717, @FiscalYear = 2020, @ConsolidationGroup = 'G_AXYZ', @DebugBM=19
