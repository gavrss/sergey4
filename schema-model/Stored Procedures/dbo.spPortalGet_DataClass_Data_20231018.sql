...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalGet_DataClass_Data_20231018]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data] @ActingAs='3238',@AssignmentID='22021',@DataClassID='5587',@DebugBM='63',
@Filter='Flow=NONE|Time=202301,202302,202303,202304,202305,202306,202307,202308,202309,202310,202311,202312|Scenario=FORECAST_JUN23|Entity=COXUK|Currency=GBP|Account=5983|GL_Department=110|GL_Division=00|GL_Phase=000|GL_Project=000|GL_Reference=NONE|BusinessProcess=INPUT|TimeDataView=RAWDATA|Version=NONE|BusinessRule=NONE',
@GroupBy='Time|Account',@InstanceID='549',@Measure='Financials',@ResultTypeBM='8',@RowList='SupressZeroYN=0',@UseCacheYN='true',@UserID='10046',@VersionID='1062'
