...
SET ANSI_NULLS ON
GO
create PROCEDURE [dbo].[spIU_DC_Journal_EpicorERP_20231103]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2199' SET @Description = 'DB-1610: For @SequenceBM = 2 (Opening Balances), insert [JournalSequence] = ''OB_ERP'' rows for non-zero [GLPeriodBal].[OpenBalance] values only.'
