...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spBR_BR05_JaWo]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
												...
												IF @InterCompany_BusinessRuleID IS NOT NULL
													BEGIN
														...
														--EXEC [spBR_BR14] 
															...
															--@InstanceID=@InstanceID,
															--@VersionID=@VersionID,
															--@BusinessRuleID=@InterCompany_BusinessRuleID,
															--@FiscalYear=@FiscalYear,
															--@JournalTable = '#JournalBase',
															--@JobID=@JobID,
															--@Debug=@DebugSub
													END
