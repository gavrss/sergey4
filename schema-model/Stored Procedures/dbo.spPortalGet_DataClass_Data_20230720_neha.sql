...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalGet_DataClass_Data_20230720_neha]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
AS
/*
EXEC [pcINTEGRATOR].[dbo].[spPortalGet_DataClass_Data_20230720_neha] @ActingAs='5973',@DataClassID='5872',@UseCacheYN='true',@UserID='14572',@VersionID='1105',@InstanceID='621',
@Filter='Account=All_|Flow=All_|BusinessProcess=CONSOLIDATED|BusinessRule=All_|Currency=GBP|Entity=CO|Version=NONE|GL_Product=All_|GL_Project=All_|LineItem=All_|FullAccount:1=180',
@ResultTypeBM='512',@RowList='SupressZeroYN=1|GL_CostCentre=UKFrCentres',
@Tuple='#Tuple=actual|Time=202304|Scenario=ACTUAL',@DebugBM=31
