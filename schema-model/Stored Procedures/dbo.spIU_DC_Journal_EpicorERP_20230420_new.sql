...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spIU_DC_Journal_EpicorERP_20230420_new]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
AS
/*
EXEC [pcINTEGRATOR].[dbo].[spIU_DC_Journal_EpicorERP_20230420_new] @Book='Main',@DebugBM='3',@Entity_MemberKey='01', @FullReloadYN='1',
