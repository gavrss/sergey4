...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spBR_BR03_20230119]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
EXEC [spBR_BR03] @UserID=-10, @InstanceID=515, @VersionID=1064, @BusinessRuleID=2414, @FromTime=202001, @ToTime=202001, @Rule_AllocationID = 2001, @SequenceBM = 1, @DebugBM=24
...
EXEC [spBR_BR03] @UserID=-10, @InstanceID=515, @VersionID=1064, @BusinessRuleID=2414, @FromTime=202006, @ToTime=202007, @Rule_AllocationID = 2003, @SequenceBM = 1, @DebugBM=3

EXEC [spBR_BR03] @UserID=-10, @InstanceID=515, @VersionID=1064, @BusinessRuleID=2414, @FromTime=202006, @ToTime=202007, @SequenceBM = 1, @DebugBM=3
	...
	SET @Step = 'Run RULE_Allocation_Cursor'
		...
		IF @DebugBM & 8 > 0 
			...
			FROM
				#JournalBase 
			ORDER BY
				Entity, Book, JournalNo, JournalLine, FiscalYear, FiscalPeriod, YearMonth, Account, Segment01, Segment02, Segment03, Segment04, Segment05
