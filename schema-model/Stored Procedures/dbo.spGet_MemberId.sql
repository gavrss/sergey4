...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spGet_MemberId]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
EXEC [spGet_MemberID] @InstanceID = 454, @VersionID = 1021, @DimensionID = -63, @MemberKey = '6810_Input/Adjust Budget', @MemberId = @MemberId OUT, @Debug = 1
SELECT [@MemberId] = @MemberId

EXEC [spGet_MemberId] @GetVersion = 1
*/
...
BEGIN TRY
	...
	SET @Step = 'Calculate @MemberKey'
		...
		IF @Debug <> 0 SELECT [@MemberId] = @MemberId
