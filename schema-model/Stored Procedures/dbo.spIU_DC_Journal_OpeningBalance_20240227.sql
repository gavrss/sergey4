...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spIU_DC_Journal_OpeningBalance_20240227]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
IF @GetVersion <> 0
	BEGIN
		...
		IF @Version = '2.1.2.2199' SET @Description = 'Special case for #FiscalYear table, @InstanceID = 603, @VersionID = 1095, @Entity_MemberKey = Honematic, @Book = GL, @FiscalYear = 2022'
