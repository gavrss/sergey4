...
CREATE PROCEDURE [dbo].[spGet_Entity_FiscalYear_20230110]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
EXEC dbo.[spGet_Entity_FiscalYear] @UserID = -10, @InstanceID = 603, @VersionID = 1095, @EntityID = 15122, @Book = 'GL', @FiscalYear=2023, @FiscalPeriod13YN = 1, @FiscalPeriod0YN = 1, @Debug = 1
