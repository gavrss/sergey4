...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spPortalGet_DataClass_Data_20230922_nehatest]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
	...
	SET @Step = '@ResultTypeBM & 8'
		IF @ResultTypeBM & 8 > 0 --Changeable
			BEGIN
				...
				EXEC [spGet_WriteAccess_20230922_nehatest] @UserID = @UserID, @InstanceID = @InstanceID, @VersionID = @VersionID, @AssignmentID = @AssignmentID, @DataClassID = @DataClassID
