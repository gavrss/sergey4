...
CREATE PROCEDURE [dbo].[spBR_BR01_20220906]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
--@segaRows BIGINT,
	...
	@Version nvarchar(50) = '2.1.2.2184'
...
--					SET @PipeString = @BaseObject + '=' + @MemberKey + CASE WHEN @DimensionFilterStep IS NOT NULL THEN '|' + @DimensionFilterStep ELSE '' END
					...
					SELECT
						@SQL_Where = @SQL_Where + 
										case when 1=0 /*@InstanceID = 454*/ then
												CASE 
													WHEN CASE 
															...
															IS NOT NULL THEN CHAR(13) + CHAR(10) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + 'EXISTS (SELECT TOP 1 1 FROM #FilterTableSmall FTS WHERE FTS.DimensionName = ''' + FT.[DimensionName] + ''' and FTS.Value1 = DC.[' + FT.[DimensionName] + '_MemberID]) AND' 
													ELSE ''
													END
												else
												CASE 
													WHEN CASE 
																...
																ELSE FT.[LeafLevelFilter] 
																END 
															IS NOT NULL THEN CHAR(13) + CHAR(10) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + CHAR(9) + 'DC.[' + FT.[DimensionName] + '_MemberID] IN (' + FT.[LeafLevelFilter] + ') AND' 
