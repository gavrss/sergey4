...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spIU_DC_Journal_OpeningBalance_20231005]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
...
AS
/*
EXEC [pcINTEGRATOR].[dbo].[spIU_DC_Journal_OpeningBalance] @UserID='-10',@InstanceID='572',@VersionID='1080',@Book='Main',@Entity_MemberKey='GB01_X',@FiscalYear='2021',@SaveToJournalYN=1, @DebugBM = 2
