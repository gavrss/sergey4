...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[spBR_BR03_20230828]
	@UserID int = NULL,
	@InstanceID int = NULL,
	@VersionID int = NULL,
						...
						BEGIN
							...
							SET @SQLStatement = @SQLStatement + '
								SELECT
									...
									[Entity] = ''REM'',
									[Book] = ''GL'',
									[FiscalYear] = LEFT(J.[Time], 4),
									[FiscalPeriod] = J.[Time] % 100,
									[YearMonth] = J.[Time],
									[BalanceYN] = 0, --MAX(CONVERT(int, J.[BalanceYN])),
									[Account] = J.[Account],
									[Segment01] = [GL_Branch].[MemberKeyBase],
									[Segment02] = '''',
									[Segment03] = J.[GL_Contact],
									[Segment04] = '''',
									[Segment05] = '''',
									[Segment06] = '''',
									[Segment07] = '''',
									...
									[Scenario] = ''ACTUAL'',
									[Currency_Book] = ''USD'',
									[Value_Book] = J.[AllocBaseData_Value]'
