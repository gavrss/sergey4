...
create PROCEDURE [dbo].[spPortalGet_DataClass_Data_20230705_sega_beforeAggregationCursorUpdate]
	@UserID INT = NULL,
	@InstanceID INT = NULL,
	@VersionID INT = NULL,
...
--' + @SQL_Join2 + '
				...
				DECLARE Aggregation_Cursor CURSOR FOR
					...
					/*20230623 sega: commented below line with Nevhan and want to discuss with Jan later*/
					-- EXEC(@SQLStatement)
